    ...
    >
      ...
      >
        <template
          ...
          :key="index"
        >
          <template v-if="defaultDomain === getUser().subdomain && item.access === 'velma'">
            <Component
              :is="resolveNavItemComponent(item)"
              :item="item"
            />
          </template>
          <template v-if="defaultDomain?.toLowerCase() !== getUser().subdomain && item?.access == 'company'">
            <Component
              :is="resolveNavItemComponent(item)"
              :item="item"
            />
          </template>
          <template v-if="item?.access == 'all'">
            <Component
              :is="resolveNavItemComponent(item)"
              :item="item"
            />
