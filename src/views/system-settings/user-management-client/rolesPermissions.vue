...
import CustomDrawer from '@/@core/components/CustomDrawer.vue';
...
<template>
  ...
  <PermissionsDrawer
    ...
    :toggle-modal="closePermissionModal"
    :roles="roles"
    :handle-change="handlePermissionChange"
    :is-local-dialog-visible="isLocalDialogVisible"
